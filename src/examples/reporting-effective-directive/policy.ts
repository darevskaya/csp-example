...
export const MODE_CONFIG: Record<EffectiveDirectiveMode, ModeConfig> = {
  'default-src': {
    ...
    directives: { ...REPORTING_BASE_DIRECTIVES },
  ...
  'script-src': {
    ...
    highlight: ['effectiveDirective', 'originalPolicy'],
    directives: { ...REPORTING_BASE_DIRECTIVES, 'script-src': `'self'` },
  ...
  'script-src-attr': {
    ...
    highlight: ['effectiveDirective', 'originalPolicy'],
    directives: { ...REPORTING_BASE_DIRECTIVES, 'script-src-attr': `'none'` },
    displayDirectives: {
      'default-src': `'self'`,
...
export function buildEffectiveDirectivePolicy(mode: EffectiveDirectiveMode) {
  const { directives, displayDirectives } = MODE_CONFIG[mode];
  return {
